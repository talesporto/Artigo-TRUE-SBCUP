...
Reconhecimento. Tais testes foram realizados no Laboratório LAICO (LAboratório
de Sistemas Integrados e COncorrentes) do Departamento de Ciência da Computação da
Universidade de Brasília. O ambiente onde os mesmos foram realizados é
...
Durante os testes realizados com rastreamento observamos alguns problemas
