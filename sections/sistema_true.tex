...
\begin{figure}[htb]
	\begin{center}
		\includegraphics[scale=0.30]{img/modulo-integracao.png}
	\end{center}
...
dimensionalidades, e são calculadas suas distâncias em relação aos \emph{eigenfaces}
...
ser utilizados pelo Módulo de Reconhecimento. Após o treinamento, o Sistema TRUE é reiniciado para que o reconhecimento seja
